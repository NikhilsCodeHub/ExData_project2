...
## Search for rows containing Coal Combustion related sources
plotData<-allData[grep("Coal", allData$SCC.Levels),]
...
##=== Copy Plot to PNG
dev.copy(png, "plot4.png", width=600, height=600, units="px")
dev.off()
